...
Realmode.SecondStage.UserLoaded.Msg			db 'User progam loaded into memory',CR,LF,0
...
read_user_from_disk:
  ...
  ; Read the user file from the disk.
  xor edx, edx
  ...
  ; status message
  mov si, Realmode.SecondStage.UserLoaded.Msg
  call display_string
